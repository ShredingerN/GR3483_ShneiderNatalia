...
int firstNumber = number/10; //72 72/10=7,2, int отбрасывает все цифры после запятой 
int secondNumber = number%10;//72 72%10=2 получение остатка от деления, то есть второй цифры
