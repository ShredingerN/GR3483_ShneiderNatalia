...
// Метод простой сортировки подсчетом я поняла, где даипазон элементов массива от 0 до k, но со случайной подборкой элементов массива он не работает.
// Проходимся по массиву, подсчитываем количество одинаковых элементов с помощью массива счетчика, на выходе расставляем попорядку от наименьшего. 
